...
#              to make changes
# INPUTS:  df_in_1              = dataframe containing character or factor vector to check spelling.
#          var_name_1           = bare parameter name indicating the vector to check spelling.
#          df_in_2              = second data frame with additional character vector.
#          var_name_2           = bare parameter name indicating the vector to add to the first vector.
